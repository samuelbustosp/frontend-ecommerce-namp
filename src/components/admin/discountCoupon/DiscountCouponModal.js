...
const DiscountCouponModal = ({isOpen, onClose, onAddDiscountCoupon, onUpdateDiscountCoupon, discountCouponToEdit}) => {
    ...
    useEffect(() => {
        if (discountCouponToEdit) {
            setDiscountCoupon({
                descuento: discountCouponToEdit.descuento,
                vigente: discountCouponToEdit.vigente
            });
        } else {
            setDiscountCoupon({ 
                descuento: 0,
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <TextInput
                                ...
                                name="descuento"
                                type="text" 
                                value={discountCoupon.descuento}
                    ...
                    {isEditMode && (
                        <div className="mb-4">
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                ...
                                id="vigente"
                                name="vigente"
                                checked={discountCoupon.vigente}
                                onChange={handleInputChange}
