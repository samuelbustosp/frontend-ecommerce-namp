...
const useFetchStockStats = (startDate, endDate) => {
    ...
    useEffect(() => {
        const fetchStockData = async () => {
            ...
            try {
                ...
                const url = `http://localhost:8080/api-namp/admin/getStockByPeriod?startDate=${start}&endDate=${end}`;
                console.log(url);
                ...
                console.log(data)
                setStockData(data); // Guarda los datos
...
export default useFetchStockStats;
